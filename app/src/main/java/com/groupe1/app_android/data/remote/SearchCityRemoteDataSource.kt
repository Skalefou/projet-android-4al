...
import com.groupe1.app_android.data.remote.services.SearchCityService
import com.groupe1.app_android.networks.NetworkModule
import retrofit2.Retrofit

open class SearchCityRemoteDataSource(
    api: Retrofit = NetworkModule.searchBarCityApi
) {
    private val searchCityService = api.create(SearchCityService::class.java)
